...
resource "aws_launch_configuration" "launch" {
  ...
  # 2018-09-04: For convenience whlie using free tier, allow direct access
...
resource "aws_autoscaling_group" "asg" {
  ...
  // TODO using public subnets here, which is less secure, but good for
  //   AWS free-tier, as we only have one EC2 instance and can't set up a bastion.
